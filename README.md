...
[docs/cleaner-manual.pdf](docs/cleaner-manual.pdf)** — a front page and seven
pages behind it: logging in, adding the app to a phone, reading the day's
list, marking a building done, reporting a problem, the roster and setting
availability. There's an editable Word copy at
